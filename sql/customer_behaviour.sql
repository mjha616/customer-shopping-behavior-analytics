...
SELECT COUNT(*) AS locations FROM dim_locations;
SELECT COUNT(*) AS shipping FROM dim_shipping;
SELECT COUNT(*) AS payments FROM dim_payment;
SELECT COUNT(*) AS purchases FROM fact_purchases;
